...
export default function Todo() {
  ...
  const [popupType, setPopupType] = useState(["alert","info"]);
      ...
      case "error":
        return (
          <div className="popup error-popup">
            ...
            <div className="error-message">警告！水溫過高 建議啟動抽水機12分鐘 預估水溫能夠降至20度。</div>
            <div
              className="popup-icon close-icon"
      ...
      case "info":
        return (
          <div className="popup info-popup">
            ...
            <div className="info-message">信息！明天傍晚會下大暴雨 請提前放水。</div>
            <div
              className="popup-icon close-icon"
              onClick={() => setPopupType(null)}
            >
